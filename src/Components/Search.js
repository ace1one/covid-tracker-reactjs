...
const Search = () => {
    const {nepal,setNepal,search,setSearch,setCountry} = useContext(covidContext);
    ...
    return (
        <div class="input-group mb-3"  style={{width:"662px"}}>
        ...
        <div class="input-group-append">
          ...
          class="btn btn-outline-primary" type="button">Search</button>
        </div>
           </div>
